...
std::map<std::string, ObjData> stage1_mapData = {
    ...
    {"Rock_02",     ObjData{"Data/Stage/SimpleNaturePack/Models/Rock_02.mdl",      COLLISION_SPHERE,    RayCastOFF,     1.6f,1.0f,1.0f,1.0f}},
    {"Rock_03",     ObjData{"Data/Stage/SimpleNaturePack/Models/Rock_03.mdl",      COLLISION_SPHERE,    RayCastOFF,     1.1f,1.0f,1.0f,1.0f}},
